...
@property (weak, nonatomic) id<ThunderVideoFrameConsumer> consumer;
...
- (void)turnOnRecord {
    ...
    if (@available(iOS 11.0, *)) {
        [recorder startCaptureWithHandler:^(CMSampleBufferRef  _Nonnull sampleBuffer, RPSampleBufferType bufferType, NSError * _Nullable error) {
            ...
            [self->_consumer consumePixelBuffer:pixelBuffer withTimestamp:CMSampleBufferGetPresentationTimeStamp(sampleBuffer) rotation:THUNDER_VIDEO_ROTAION_NONE];
